...
int findMinMovingAveragePSNR(BITMAPFILEHEADER fileHeader, BITMAPINFOHEADER infoHeader, std::vector<std::vector<unsigned char>>& Y, int H, int W, int R_max){
    ...
    std::cout << "Minimum PSNR = " << minPSNR << "; R = " << R_save << std::endl;
